...
<title>hutten.be &bull; Frequently Asked Questions</title>
...
<div id="wrapheader">
	...
	<div id="datebar">
		<table width="100%" cellspacing="0">
		<tr>
			<td class="gensmall">Last visit was: Sat Sep 12, 2009 6:54 am</td>
			<td class="gensmall" align="right">It is currently Sat Sep 12, 2009 6:54 am<br /></td>
		</tr>
		</table>
	</div>
...
<div align="right">	<form method="post" name="jumpbox" action="./viewforum.php" onsubmit="if(document.jumpbox.f.value == -1){return false;}">
	...
	<tr>
		...
		<option value="-1">------------------</option>			<option value="19">Over het forum</option>
					<option value="1">&nbsp; &nbsp;Hoe werkt dit forum?</option>
					<option value="17">&nbsp; &nbsp;Nog vragen over dit forum?</option>
					<option value="20">Landeninformatie</option>
					<option value="2">&nbsp; &nbsp;Duitsland</option>
					<option value="3">&nbsp; &nbsp;Frankrijk</option>
					<option value="4">&nbsp; &nbsp;Italië</option>
					<option value="5">&nbsp; &nbsp;Oostenrijk</option>
					<option value="6">&nbsp; &nbsp;Spanje</option>
					<option value="7">&nbsp; &nbsp;Zwitserland</option>
					<option value="8">&nbsp; &nbsp;Andere landen</option>
					<option value="21">Berghutten</option>
					<option value="9">&nbsp; &nbsp;Ervaringen</option>
					<option value="10">&nbsp; &nbsp;Routebeschrijvingen</option>
					<option value="22">Bergtoppen</option>
					<option value="11">&nbsp; &nbsp;Voor de klimmers</option>
					<option value="23">Diversen</option>
					<option value="12">&nbsp; &nbsp;Reisverslagen</option>
					<option value="13">&nbsp; &nbsp;Vakantieverblijven</option>
					<option value="14">&nbsp; &nbsp;Actualiteit</option>
					<option value="15">&nbsp; &nbsp;Test jouw kennis</option>
