...
<body>
<h1>The website you were trying to reach is temporarily unavailable.</h1>
<div id="wrap">
  <div class="msg">
    <h2><strong>Please check back soon.</strong></h2>
    <p> If you are the owner of this website, please contact Technical Support as soon as possible.</p>
  </div>
</div>
</body>
</html>
